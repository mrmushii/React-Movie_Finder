...
const MovieDetails = () => {
  ...
  return (
    <div className="movie-card xl:px-18 sm:px-2 md:px-2 xs:px-2 max-xs:px-1">
      ...
      <br />
      <br />
      <div className="flex xl:flex-row justify-between gap-18 rounded-4xl m-20 max-sm:mx-1.5">
      ...
      <div className="mx-20 bg-gray-800 text-white rounded-2xl shadow-lg p-6 space-y-4 max-w-screen max-sm:mx-2.5">
            <div>
